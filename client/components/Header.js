...
import hippyswapLogo from '../assets/uniswap.png'
...
const style ={ 
    ...
    navItemsContainer:`flex bg-[#1B1E29] rounded-3xl`,
    navItem:`px-4 py-2 m-1 flex items-center text-lg font-semibold text-[0.9rem] cursor-pointer rounded-3xl`,
    activeNavItem:`bg-[#404557] rounded-3xl`,
    buttonsContainer:`flex w-1/4 justify-end items-center`,
    button:`flex items-center bg-[#1B1E29] rounded-2xl mx-2 text-[0.9rem] font-semibold cursor-pointer `,
    buttonPadding:`p-2`,
    buttonTextContainer:`h-8 w-33 flex items-center`,
  ...
  return(
    <div className={style.wrapper}>
        <div className={style.headerLogo}>
            <Image src={hippyswapLogo} alt="uniswap" height={40} width={40} />
        </div>  
